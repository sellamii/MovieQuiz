 ...
 function Questions(props) {
    ...
    return (
        ...
        <div className="Questions_buttons">
            <button value={true} onClick={this.handleClick} className='Questions_button-T button'>Yes</button>
            <button value={false} onClick={this.handleClick} className='Questions_button-F button'>No</button>
        </div>
    </div>
    )
}
